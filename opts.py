...
def parse_opt():
    ...
    parser.add_argument('--input_fc_dir', type=str, default='/data/VG/cocobu_fc',
                    help='path to the directory containing the preprocessed fc feats')
    parser.add_argument('--input_att_dir', type=str, default='/data/VG/cocobu_att',
                    help='path to the directory containing the preprocessed att feats')
    parser.add_argument('--input_box_dir', type=str, default='/data/VG/cocobu_box',
    ...
    parser.add_argument('--topic_vec_size', type=int, default=768,
                    help='topic vector dimentions')
    ...
    parser.add_argument('--max_length', type=int, default=175,
    ...
    parser.add_argument('--print_freq', type=int, default=0,
...
def add_eval_options(parser):
    ...
    parser.add_argument('--eval_results_dir', type=str, default='eval_results', 
                    help='path to the eval results folder')
